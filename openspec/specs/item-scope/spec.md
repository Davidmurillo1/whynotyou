...
Permitir clasificar cada ítem entre **estudio** (`study`) y **trabajo** (`work`) para que el producto sirva más allá del caso original de aprendizaje. Esta capability también cubre la **edición libre de atributos** del ítem (título, tipo, unidad, cantidad total, URL) y el **copy adaptativo** del greeting cuando hay ítems de trabajo activos. Es el cimiento sobre el que se construyen las stats desglosadas y el filtro de biblioteca.
